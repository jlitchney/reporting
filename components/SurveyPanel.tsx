                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {q.correctOption !== undefined && (
                          <span className="flex-shrink-0 rounded-full bg-amber-100 px-2 py-0.5 text-[10px] font-semibold text-amber-700">Graded</span>
                        )}
                      </div>
                  ...
                  {q.options && (
                    <div className="ml-8 space-y-1.5">
                      {q.options.map((opt) => {
                        ...
                        const isGraded = q.correctOption !== undefined;
                        return (
                          <div
                            key={opt}
                          ...
                          >
                            <span className={`h-3.5 w-3.5 flex-shrink-0 border-2 ${
                              isGraded
                                ? isCorrect ? 'border-emerald-400' : 'border-red-300'
                                : 'border-slate-300'
                            } ${q.type === 'multiple_choice' ? 'rounded-sm' : 'rounded-full'}`} />
